abstract class AppImagesPhonetics {
  ...
  static const String memoryCardTitle =
      "${mainPathOfImages}memoryCardTitle.png";
  static const String completeTheSentence =
      "${mainPathOfImages}completeTheSentenceGame.png";
