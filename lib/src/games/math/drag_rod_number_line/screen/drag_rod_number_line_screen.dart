...
import '../manager/drag_rod_number_line_cubit.dart';

class DragRodNumberLineScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: BlocConsumer<DragRodNumberLineCubit, DragRodNumberLineInitial>(
                                              ...
                                              children: [
                                                Draggable<GameChoicesGameFinalModel>(
                                                    feedback: CardOfNumberDDt(
                                                        width: 99.h,
                                                        height: 99.h,
                                                        number: gameState.gameChoices?[index].choice ??
                                                            '0',
                                                        isCorrect: gameState.isCorrect == true &&
                                                            gameState.gameChoices?[index].isCorrect ==
                                                                1),
                                                    data: gameState
                                                        .gameChoices?[index],
