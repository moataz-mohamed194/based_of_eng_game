part of 'drag_rod_number_line_cubit.dart';

@immutable
final class DragRodNumberLineInitial extends Equatable {
  ...
  DragRodNumberLineInitial copyWith({
    ...
    return DragRodNumberLineInitial(
